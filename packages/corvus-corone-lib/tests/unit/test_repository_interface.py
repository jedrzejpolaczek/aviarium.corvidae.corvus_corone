"""Interface contract tests for RepositoryFactory implementations.

All tests in this module run against **both** ``InMemoryRepositoryFactory``
and ``LocalFileRepository`` via the parametrized ``factory`` fixture.
This directly demonstrates the ADR-001 swap guarantee: every contract that
holds for the in-memory backend holds identically for the file backend, and
client code needs zero changes to switch between them.
...
→ docs/02-design/01-software-requirement-specification/07-acceptance-test-strategy/
  01-acceptance-test-strategy.md  (REF-TASK-0023, REF-TASK-0036 acceptance criteria)
"""
...
@pytest.fixture(params=["in_memory", "local_file"])
def factory(request: pytest.FixtureRequest, tmp_path: pytest.TempPathFactory) -> RepositoryFactory:
    """Parametrized fixture: each test runs against InMemory *and* LocalFile backends.

    ADR-001 swap guarantee: the same contract tests pass for both implementations
    without any changes to the test body.
    """
    if request.param == "in_memory":
        return InMemoryRepositoryFactory()
    return LocalFileRepository(tmp_path)
...
class TestProblemRepository:
    def test_register_returns_uuid(self, factory: RepositoryFactory) -> None:
    ...
    def test_get_returns_registered_entity(self, factory: RepositoryFactory) -> None:
    ...
    def test_get_returns_deep_copy(self, factory: RepositoryFactory) -> None:
    ...
    def test_get_unknown_id_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_list_returns_all_non_deprecated(self, factory: RepositoryFactory) -> None:
    ...
    def test_list_with_dimension_filter(self, factory: RepositoryFactory) -> None:
    ...
    def test_register_missing_name_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_deprecate_unknown_id_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_deprecated_still_retrievable_by_id(self, factory: RepositoryFactory) -> None:
...
class TestAlgorithmRepository:
    ...
    def test_get_unknown_raises(self, factory: RepositoryFactory) -> None:
        with pytest.raises(EntityNotFoundError):
            factory.algorithms.get_algorithm("00000000-0000-4000-8000-000000000000")

    def test_register_empty_justification_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_register_unpinned_code_reference_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_register_pinned_with_at_sign(self, factory: RepositoryFactory) -> None:
    ...
    def test_deprecate_removes_from_listing(self, factory: RepositoryFactory) -> None:
        aid = factory.algorithms.register_algorithm(VALID_ALGORITHM.copy())
...
class TestStudyRepository:
    def test_create_returns_uuid(self, factory: RepositoryFactory) -> None:
        sid = factory.studies.create_study(VALID_STUDY.copy())
        assert_uuid(sid)

    def test_create_sets_draft_status(self, factory: RepositoryFactory) -> None:
        """create_study() must always produce status='draft' (pre-lock)."""
        sid = factory.studies.create_study(VALID_STUDY.copy())
        study = factory.studies.get_study(sid)
        assert study["status"] == "draft"

    def test_create_ignores_caller_status(self, factory: RepositoryFactory) -> None:
    ...
    def test_lock_transitions_status(self, factory: RepositoryFactory) -> None:
        sid = factory.studies.create_study(VALID_STUDY.copy())
        factory.studies.lock_study(sid)
        study = factory.studies.get_study(sid)
        assert study["status"] == "locked"

    def test_lock_already_locked_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_lock_unknown_id_raises(self, factory: RepositoryFactory) -> None:
        with pytest.raises(EntityNotFoundError):
            factory.studies.lock_study("00000000-0000-4000-8000-000000000000")

    def test_lock_missing_required_field_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_list_with_status_filter(self, factory: RepositoryFactory) -> None:
    ...
    def test_list_with_problem_ids_overlap_filter(self, factory: RepositoryFactory) -> None:
...
class TestExperimentRepository:
    def _create_locked_study(self, factory: RepositoryFactory) -> str:
        sid = factory.studies.create_study(VALID_STUDY.copy())
        factory.studies.lock_study(sid)
        return sid
    ...
    def test_create_sets_running_status(self, factory: RepositoryFactory) -> None:
        sid = self._create_locked_study(factory)
        eid = factory.experiments.create_experiment({"study_id": sid})
        exp = factory.experiments.get_experiment(eid)
        assert exp["status"] == "running"

    def test_update_mutable_field(self, factory: RepositoryFactory) -> None:
        sid = self._create_locked_study(factory)
        eid = factory.experiments.create_experiment({"study_id": sid})
        factory.experiments.update_experiment(eid, status="completed")
        assert factory.experiments.get_experiment(eid)["status"] == "completed"

    def test_update_immutable_field_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_list_by_study_id(self, factory: RepositoryFactory) -> None:
        sid = self._create_locked_study(factory)
...
class TestRunRepository:
    ...
    def test_get_returns_registered_run(self, factory: RepositoryFactory) -> None:
    ...
    def test_update_run_fields(self, factory: RepositoryFactory) -> None:
    ...
    def test_save_and_get_performance_records(self, factory: RepositoryFactory) -> None:
    ...
    def test_performance_records_sorted_ascending(self, factory: RepositoryFactory) -> None:
    ...
    def test_duplicate_evaluation_number_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_non_monotonic_sequence_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_list_runs_by_experiment(self, factory: RepositoryFactory) -> None:
    ...
    def test_list_runs_with_status_filter(self, factory: RepositoryFactory) -> None:
    ...
    def test_save_records_unknown_run_raises(self, factory: RepositoryFactory) -> None:
        with pytest.raises(EntityNotFoundError):
            factory.runs.save_performance_records(
                "00000000-0000-4000-8000-000000000000",
...
class TestResultAggregateRepository:
    def test_save_and_retrieve_aggregates(self, factory: RepositoryFactory) -> None:
        aggregates = [
            {
    ...
    def test_save_missing_field_raises(self, factory: RepositoryFactory) -> None:
        with pytest.raises(ValidationError):
            factory.aggregates.save_result_aggregates(
                [{"experiment_id": "exp-001", "problem_id": "p1"}]  # missing required fields
            )

    def test_get_by_id(self, factory: RepositoryFactory) -> None:
        factory.aggregates.save_result_aggregates(
            [
                {
                    "experiment_id": "exp-001",
...
class TestReportRepository:
    def test_save_and_retrieve_report(self, factory: RepositoryFactory) -> None:
    ...
    def test_save_empty_limitations_raises(self, factory: RepositoryFactory) -> None:
    ...
    def test_save_missing_artifact_reference_raises(self, factory: RepositoryFactory) -> None:
        with pytest.raises(ValidationError):
            factory.reports.save_report(
                {
                    "report_type": "researcher",
    ...
    def test_list_reports_by_experiment(self, factory: RepositoryFactory) -> None:
...
class TestADR001SwapGuarantee:
    ...
    Per ADR-001: swapping ``InMemoryRepositoryFactory`` for ``LocalFileRepository``
    (or any future ``ServerRepository``) must require zero changes to client code.
    Client functions accept ``RepositoryFactory`` — not the concrete type.
    These tests run the same client functions against both production-ready backends.
    """

    def test_problem_workflow_in_memory(self) -> None:
        """Client function works with InMemoryRepositoryFactory."""
        _register_and_retrieve_problem(InMemoryRepositoryFactory())

    def test_problem_workflow_local_file(self, tmp_path: pytest.TempPathFactory) -> None:
        """Same client function works with LocalFileRepository — zero code changes."""
        _register_and_retrieve_problem(LocalFileRepository(tmp_path))

    def test_full_lifecycle_in_memory(self) -> None:
        _full_study_lifecycle(InMemoryRepositoryFactory())

    def test_full_lifecycle_local_file(self, tmp_path: pytest.TempPathFactory) -> None:
        """Full lifecycle through LocalFileRepository — identical to in-memory variant."""
        _full_study_lifecycle(LocalFileRepository(tmp_path))

    def test_both_are_subtypes_of_repository_factory(
        self, tmp_path: pytest.TempPathFactory
    ) -> None:
        """Both implementations satisfy the RepositoryFactory ABC (Liskov substitution)."""
        for impl in (InMemoryRepositoryFactory(), LocalFileRepository(tmp_path)):
            factory: RepositoryFactory = impl
...
class TestNoFilePathsInIDs:
    ...
    def test_problem_id_is_not_a_path(self, factory: RepositoryFactory) -> None:
        pid = factory.problems.register_problem(VALID_PROBLEM.copy())
        assert "/" not in pid
        assert "\\" not in pid
        assert not pid.endswith(".json")

    def test_algorithm_id_is_not_a_path(self, factory: RepositoryFactory) -> None:
        aid = factory.algorithms.register_algorithm(VALID_ALGORITHM.copy())
        assert "/" not in aid
        assert "\\" not in aid

    def test_study_id_is_not_a_path(self, factory: RepositoryFactory) -> None:
        sid = factory.studies.create_study(VALID_STUDY.copy())
        assert "/" not in sid
        assert "\\" not in sid

    def test_experiment_id_is_not_a_path(self, factory: RepositoryFactory) -> None:
        sid = factory.studies.create_study(VALID_STUDY.copy())
        factory.studies.lock_study(sid)
        eid = factory.experiments.create_experiment({"study_id": sid})
        assert "/" not in eid
    ...
    def test_run_id_is_not_a_path(self, factory: RepositoryFactory) -> None:
        rid = factory.runs.create_run({"experiment_id": "exp-001", "seed": 0})
        assert "/" not in rid
        assert "\\" not in rid
