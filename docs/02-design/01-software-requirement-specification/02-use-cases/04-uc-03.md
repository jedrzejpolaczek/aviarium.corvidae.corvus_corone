...
- `docs/02-design/02-architecture/02-c4-leve1-context/01-c4-l1-context/01-c1-context.md` — Practitioner actor definition
- `03-functional-requirements/01-index.md`: FR-20, FR-21
- `05-constraints/01-index.md`: CONST-SCI-03, CONST-SCI-06
