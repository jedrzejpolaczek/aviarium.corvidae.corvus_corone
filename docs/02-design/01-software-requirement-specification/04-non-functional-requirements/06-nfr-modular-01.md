...
- **Operationalized in:** `docs/03-technical-contracts/02-interface-contracts/01-index.md`
...
- **Also references:** `docs/03-technical-contracts/02-interface-contracts/02-problem-interface.md`, `docs/03-technical-contracts/02-interface-contracts/03-algorithm-interface.md`
