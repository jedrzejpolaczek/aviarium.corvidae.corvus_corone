...
| ADR-030 | the Pilot proposes and never commits: it may not call `cc.lock_study()`, and every output ships the material needed to reject it. No component in any phase may name one algorithm as the one to use |
