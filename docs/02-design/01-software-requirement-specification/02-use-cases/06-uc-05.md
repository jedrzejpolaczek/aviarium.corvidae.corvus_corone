...
1. Researcher retrieves the archived Study record: Study plan, Algorithm Instance versions, Problem Instance versions, seed assignments (→ MANIFESTO Principle 19; `docs/03-technical-contracts/01-data-format/04-study.md` §2.3 – `docs/03-technical-contracts/01-data-format/06-run.md` §2.5)
