...
- **Enforced by:** The Algorithm interface design (→ `docs/03-technical-contracts/02-interface-contracts/03-algorithm-interface.md`) must be minimal enough that common wrappers require ≤15 lines
